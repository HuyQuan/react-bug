          ...
          return (
            <li key={ i } className="media second-media">
              <a className="pull-left" href="#">
                <img className="media-object"  src={ 'http://localhost/laravel/laravel/public/upload/Blog/image/' + object.image_user } alt="" />
              </a>
              <div className="media-body">
                ...
                <p>{ object.comment }</p>
                <a className="btn btn-primary" href="#comment" onClick={ (event) => this.getIdSubComment(idParent) }><i className="fa fa-reply" />Replay</a>
              </div>
            </li>
            )
          }
        ...
        if (object.id_comment == 0) {
              return (
                ...
                <li key={ i } className="media">
                    ...
                    <p>{ object.comment }</p>
                    <a className="btn btn-primary" href="#comment" onClick={ (event) => getIdSubComment(object.id) }><i className="fa fa-reply" />Replay</a>
                    </div>
                </li>
